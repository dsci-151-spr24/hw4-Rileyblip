...
```{r}
gss16 <- gss16 %>%
  mutate(advfront = if_else(advfront%in%c("Strongly agree", "Agree"), "agree", if_else(advfront%in%c("Strongly disagree", "Disagree"), "Not agree", advfront)))
...
***Both of these models resulted in errors.***
...
```
***The test did not do well either because all it got was errors.***
